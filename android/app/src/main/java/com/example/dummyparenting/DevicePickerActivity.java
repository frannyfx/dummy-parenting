...
public class DevicePickerActivity extends AppCompatActivity implements OnDeviceClickListener {
    private final static String TAG = "device_picker";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Initialise UI
        Toolbar toolbar = (Toolbar) findViewById(R.id.device_picker_toolbar);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(R.menu.device_picker_menu, menu);
        return true;
    }
    ...
    private void handleBluetoothResponse(int result) {
        Log.d(TAG, "Received REQUEST_ENABLE_BT response.");
    ...
    public void onClick(View view, int position) {
        Log.d(TAG, String.format("Selected device with index %d - %s", position, currentDeviceList[position].getName()));
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        switch (requestCode) {
            case REQUEST_ENABLE_BT:
                ...
                break;
            default:
                Log.w(TAG, "Unhandled activity result received.");
        }
    }
}
